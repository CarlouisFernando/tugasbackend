...
function addItem(e) {
    ...
    let wishDivId = "wish" + productId;

    // Mendapatkan wishlist dari localStorage, atau menginisialisasi dengan array kosong jika belum ada
    ...
    if (!wishlist.includes(productId)) {
        ...
        wishDiv.setAttribute("id", wishDivId);  // Menetapkan ID unik untuk elemen produk di wishlist
        ...
        removeBtn.setAttribute("class", "but");
        ...
        // Simpan wishlist ke dalam localStorage
